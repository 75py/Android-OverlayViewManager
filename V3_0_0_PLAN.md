...
| T10 | sample・README・3.0移行ガイド | Claude: sample / Codex: docs、相互レビュー | T07寿命統合、T08、T09 stage 1 | 作業中。sample PR57（52caec4）作成、最終build成功・対向承認済み・CI待ち。API36端末3件とHTML表示確認済み。docs PR56は現SHA対向承認・CI成功、sample統合・リンク検証待ち |
